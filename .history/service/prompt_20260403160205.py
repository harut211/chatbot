...
class GeminiService:
    ...
    def build_grounded_prompt(
        ...
        """
        return ("You are a hotel assistant. Use the provided database context as source of truth for availability and prices. " "If user asks for suggestions, prioritize matching rooms by budget and client count from the database. " "If there is no exact match, suggest closest alternatives and explain why. " f"You MUST answer only in {target_language}.\n\n" f"{room_context}\n\n" f"User question: {user_question}")
