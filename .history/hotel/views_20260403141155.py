...
def home(request):
    rooms = [
        {"name": "Deluxe Suite", "price": "$180/night", "desc": "Sea view, king bed, breakfast"},
        {"name": "Family Room", "price": "$140/night", "desc": "Two queen beds, city view"},
        {"name": "Standard Room", "price": "$95/night", "desc": "Comfortable stay for 2 guests"},
    ]
